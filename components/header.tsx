...
export default function Header() {
  return (
    <header className="z-[999] relative">
      ...
      >
        <p className="fixed top-[1rem] left-[1.5rem] w-[36px] h-[36px] bg-blue-400 justify-center items-center hidden sm:flex">
          L
        </p>
        ...
        <div className="fixed right-[1.5rem] top-[1rem] w-[36px] h-[36px] bg-blue-400 justify-center items-center hidden sm:flex">
          s
        </div>
      </motion.div>
    </header>
